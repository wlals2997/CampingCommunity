                                ...
                                <table class="table table- striped table-bordered table table-hover" id="Table" width="100%" cellspacing="0" border="1" style="table-layout: fixed">
                                    ...
                                    <div id="container" align="center">
                                            ...
                                            <div class="col-md-8 box-body">
                                                <div class="form-group">
                                                    <label>작성자</label> <input type="text" name="f_w_id"
                                                        class="form-control" readonly="readonly" value='<c:out value="${pageInfo.f_w_id}"/>'/>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label>제목</label> <input type="text" name="f_title"
                                                        class="form-control" 
                                                        readonly="readonly" value='<c:out value="${pageInfo.f_title}"/>'/>
                                                </div>
                                
                                                <div class="form-group">
                                                    <label>내용</label>
                                                    <textarea name="f_content" rows="5" readonly="readonly"
                                                        class="form-control"><c:out value="${pageInfo.f_content}"/></textarea>
                                                </div>
                                        ...
                                        <div class="box-footer">
											<c:if test="${member.id == pageInfo.f_w_id }">
