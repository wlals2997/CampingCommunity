	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="/">
					<i class="fas fa-campground"></i> <span>Home</span>
			</a></li>
			...
			<li class="nav-item active"><a class="nav-link"
				href="/tables"> <i class="far fa-file-alt"></i> <span>자유게시판</span></a>
			</li>
			<!-- 드롭다운 메뉴 추가-->
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<!-- 게시판바디 -->
						<form id="modifyForm" action="/board/updateboard" method="post">
							<div class="card-body">
									...
									<table
										...
										<div id="container" align="center">
											...
											<div class="col-md-12">
												...
												<div class="col-md-8 box-body">
													<div class="form-group">
														<label>작성자</label> <input type="text" name="f_w_id"
															class="form-control" readonly="readonly"
															value='<c:out value="${pageInfo.f_w_id}"/>' />
													</div>
													...
													<div class="form-group">
														<label>제목</label> <input type="text" name="f_title"
															class="form-control"
															value='<c:out value="${pageInfo.f_title}"/>' />
													</div>

													<div class="form-group">
														<label>내용</label>
														<textarea name="content" rows="5" class="form-control"><c:out
																value="${pageInfo.f_content}" /></textarea>
													</div>
											...
											<div class="box-footer">
												...
												<input class="btn btn-warning" id="modify_btn" type="button" value="수정 완료"> 
												<input class="btn btn-warning" id="cancel_btn" type="button" value="수정 취소">
