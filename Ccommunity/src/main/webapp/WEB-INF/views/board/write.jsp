                            ...
                            <tbody >
                                <tr>			<!-- name을 BoardVO의 변수명과 일치시켜줌 -->
                                    ...
                                    <td class="form-inline"><input type="text" id="board_writer"
                                        name="f_w_id" class="form-control" style="width: 200px" readonly="readonly" value='<c:out value="${member.id}"/>'/>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="active">제목</th>
                                    <td class="form-inline"><input type="text" id="board_title"
                                        name="f_title" class="form-control" style="width: 840px" maxlength="20" oninput="numberMaxLength(this);"/><br>
                                        </td>
                                </tr>
                                <tr>
                                    <th class="active" >내용</th>
                                    <td class="form-inline"><textarea 
                                            id="board_content" name="f_content" cols="100" rows="10"
