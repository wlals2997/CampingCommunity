	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="tables.html"> <!-- 아이콘 --> <i class="far fa-file-alt"></i>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<p class="mb-4">캠핑에 관한 자유로운 글을 써주세요!</p>
							...
							<div class="table-responsive">
								...
								<table
									...
									<c:forEach items="${list}" var="list">
										<tr>
											<td><c:out value="${list.f_seq}" /></td>
											<td><a class="move"
												href='<c:out value="${list.f_seq}"/>'> <c:out
														value="${list.f_title}" />
											</a></td>
											<td><c:out value="${list.f_regdate}" /></td>
											<td><c:out value="${list.f_w_id}" /></td>
											<td><c:out value="${list.f_cnt}" /></td>
										</tr>
									</c:forEach>
								</table>
       								...
       								<div class="pageInfo_area">
 										...
 										<ul class="pagination justify-content-center">
                							...
                							<c:if test="${pageMaker.prev}">
                   							<li class="pageInfo_btn previous"><a class="page-link" href="${pageMaker.startPage-1}">이전</a></li>
               								</c:if>
                    						...
                    						<li class="pageInfo_btn next"><a class="page-link" href="${pageMaker.endPage + 1 }">다음</a></li>
               								</c:if>
